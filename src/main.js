...
cardHolder.addEventListener("input", () => {
  ...
  ccHolder.innerText = cardHolder.value.length === 0 ? 'FULANO DA SILVA' : cardHolder.value.toUpperCase();
})

securityCodeMasked.on('accept', () => {
  updateSecurityCard(securityCodeMasked.value)
})

function updateSecurityCard(code) {
